...
![image-20200907012354184](../../../assets/image-20200907012354184.png)

$$X$$如图所示

![image-20200907012518791](../../../assets/image-20200907012518791.png)
...
![img](https://cdn.jsdelivr.net/gh/TheFoxFairy/notebook-picgo@master/img/20200926202148.png)
...
![image-20200906231454458](https://cdn.jsdelivr.net/gh/TheFoxFairy/notebook-picgo@master/img/20200926203138.png)
$$
...
![image-20200907020120635](https://cdn.jsdelivr.net/gh/TheFoxFairy/notebook-picgo@master/img/20200926203217.png)

$$ Y $$数据如图所示，

![image-20200907020130512](https://cdn.jsdelivr.net/gh/TheFoxFairy/notebook-picgo@master/img/20200926203228.png)
...
![image-20200907020311234](https://cdn.jsdelivr.net/gh/TheFoxFairy/notebook-picgo@master/img/20200926203241.png)
...
![image-20200907020513426](https://cdn.jsdelivr.net/gh/TheFoxFairy/notebook-picgo@master/img/20200926203321.png)
...
![img](https://cdn.jsdelivr.net/gh/TheFoxFairy/notebook-picgo@master/img/20200926203412.png)
...
![image-20200907022959395](https://cdn.jsdelivr.net/gh/TheFoxFairy/notebook-picgo@master/img/20200926203830.png)



可视化：

![img](https://cdn.jsdelivr.net/gh/TheFoxFairy/notebook-picgo@master/img/20200926203846.png)
...
![img](https://cdn.jsdelivr.net/gh/TheFoxFairy/notebook-picgo@master/img/20200926203856.png)
...
![avatar](https://cdn.jsdelivr.net/gh/TheFoxFairy/notebook-picgo@master/img/20200926203914.png)

（2）梯度更新时，w1,w2使用了一样的学习率，可以让w1,w2使用不一样的学习率进行更新，比如对w2使用更大的学习率进行更新（可以利用学习率自适应一类的梯度下降法，比如adam），如下图：
![avatar](https://cdn.jsdelivr.net/gh/TheFoxFairy/notebook-picgo@master/img/20200926204412.png)
...
![image-20200907030158945](../../../assets/image-20200907030158945.png)
...
![img](https://cdn.jsdelivr.net/gh/TheFoxFairy/notebook-picgo@master/img/20200926204444.png)
...
![img](https://cdn.jsdelivr.net/gh/TheFoxFairy/notebook-picgo@master/img/20200926204457.png)
...
![img](https://cdn.jsdelivr.net/gh/TheFoxFairy/notebook-picgo@master/img/20200926204501.png)
...
![拟合](https://cdn.jsdelivr.net/gh/TheFoxFairy/notebook-picgo@master/img/20200926204507.png)
...
![img](https://cdn.jsdelivr.net/gh/TheFoxFairy/notebook-picgo@master/img/20200926204801.png)
...
![img](https://cdn.jsdelivr.net/gh/TheFoxFairy/notebook-picgo@master/img/20200926204830.png)
...
![img](https://cdn.jsdelivr.net/gh/TheFoxFairy/notebook-picgo@master/img/20200926204922.png)
...
![img](https://cdn.jsdelivr.net/gh/TheFoxFairy/notebook-picgo@master/img/20200926205144.png)
...
lasso = Ridge(alpha=100)
lasso.fit(X2[:,:-1],Y2)
predict = lasso.predict(X2[:,:-1])
plt.plot(X2[:,:-1],predict)
plt.scatter(X2[:,:-1],Y2)
```

![img](https://cdn.jsdelivr.net/gh/TheFoxFairy/notebook-picgo@master/img/20200926205154.png)
...
![img](https://cdn.jsdelivr.net/gh/TheFoxFairy/notebook-picgo@master/img/20200926205202.png)
