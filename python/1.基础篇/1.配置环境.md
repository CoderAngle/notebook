...
![img](../../assets/1.2.1.1-14.png)

粘贴复制到刚才编辑变量处，点击新建

![img](../../assets/1.1.2.1-15.png)
...
![img](../../assets/1.2.1.3-2.png)

然后右键点中项目，然后选中New > Python File

![image-20200909234144187](../../assets/image-20200909234144187.png)
...
![img](../../assets/1.2.1.3-5.png)

#### 编码设置

为了避免编码带来的问题，对文件编码进行设置

![img](../../assets/1.2.1.3-6.png)

#### 环境配置

当有多个版本的时候，可以通过Project Interpreter 方便的进行管理

![image-20200909234206816](../../assets/image-20200909234206816.png)
...
![img](../../assets/1.2.1.3-9.png)

或者

![img](../../assets/1.2.1.3-10.png)
...
![img](../../assets/v2-7cda50d4e2f7db7b2754f02a2344e432_hd.jpg)
...
![image-20200909075045534](../../assets/image-20200909075045534.png)
